...
{
    [HarmonyPatch]
    public sealed class SystemCompassInventory : ModSystem
    {
        public override void StartClientSide(ICoreClientAPI api)
        {
            ClientMain.ClassRegistry.RegisterInventoryClass("compass", typeof(InventoryPlayerCompass));
        ...
        {
            ServerMain.ClassRegistry.RegisterInventoryClass("compass", typeof(InventoryPlayerCompass));
        ...
        {
            string key = "compass" + "-" + player.WorldData.PlayerUID;
            if (!player.InventoryManager.Inventories.ContainsKey(key))
            {
                InventoryBasePlayer inventory = (InventoryBasePlayer)ServerMain.ClassRegistry.CreateInventory("compass", key, player.Entity.Api);
